...
comparison_grid_d2 <- expand_grid(
  ...
  mutate(
    ...
    sat_balanced = map2_dbl(n1_bal, n2_bal, ~grimu_saturation(.x, .y, decimals = 2)),
    sat_unbalanced = map2_dbl(n1_unbal, n2_unbal, ~grimu_saturation(.x, .y, decimals = 2)),
    sat_unbalanced_extreme = map2_dbl(n1_unbal_extreme, n2_unbal_extreme, ~grimu_saturation(.x, .y, decimals = 2))
  )
...
comparison_grid_d4 <- expand_grid(
  ...
  mutate(
    ...
    # Calculate Saturation (3 decimal places)
    sat_balanced = map2_dbl(n1_bal, n2_bal, ~grimu_saturation(.x, .y, decimals = 4)),
    sat_unbalanced = map2_dbl(n1_unbal, n2_unbal, ~grimu_saturation(.x, .y, decimals = 4)),
    sat_unbalanced_extreme = map2_dbl(n1_unbal_extreme, n2_unbal_extreme, ~grimu_saturation(.x, .y, decimals = 4))
  )
...
comparison_grid_d2_full <- expand_grid(
  ...
  mutate(
    ...
    sat_balanced = map2_dbl(n1_bal, n2_bal, 
                           ~grimu_saturation(.x, .y, decimals = 2, p_threshold = 1.0)),
...
comparison_grid_d3_full <- expand_grid(
  ...
  mutate(
    ...
    # We explicitly pass p_threshold = 1.0 to check the entire probability space
    sat_balanced = map2_dbl(n1_bal, n2_bal, 
                           ~grimu_saturation(.x, .y, decimals = 3, p_threshold = 1.0)),
...
comparison_grid_d4_full <- expand_grid(
  ...
  mutate(
    ...
    # We explicitly pass p_threshold = 1.0 to check the entire probability space
    sat_balanced = map2_dbl(n1_bal, n2_bal, 
                           ~grimu_saturation(.x, .y, decimals = 4, p_threshold = 1.0)),
