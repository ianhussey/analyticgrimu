...
The “one-tie” σ is a very narrow tie model: This is not a bug, but a red-team point: calling it sigma_one_tie and treating it as “ties variance” may mislead users into thinking you’re covering tie correction generally. Real tie structures can reduce σ much more than a single pair tie; if you are using this as a permissive safeguard, that’s fine, but the naming/documentation should make the limitation explicit.
...
Reworked as an R package with many checks and bug fixes.

```{r}

library(analyticgrimu) # devtools::install_github("ianhussey/analtyicgrimu")

# consistent
check1 <- grimu_check(n1 = 18, n2 = 60, u_reported = 710, p_reported = 0.04, digits = 2)
check1

check1b <- grimu_check(n1 = 18, n2 = 60, u_reported = 810, p_reported = 0.04, digits = 2)
check1b

# inconsistent
check2 <- grimu_check(n1 = 3, n2 = 3, p_reported = 0.01, digits = 2)
check2
...
res <- bind_rows(
  grimu_check(n1 = 6, n2 = 6, p_reported = .007, digits = 3)$summary,
  grimu_check(n1 = 6, n2 = 6, p_reported = .001, digits = 3)$summary,
  grimu_check(n1 = 6, n2 = 6, comparison = "less_than", p_reported = .001, digits = 3)$summary,
) |>
  select(n1, n2, consistent, p_reported, p_range_min, p_range_max, u_range_min, u_range_max) |>
